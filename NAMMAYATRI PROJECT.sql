...
--QUOTE FOR CANCELLATION RATE
--BOOKING CANCELLATION RATE
--CONVERSION RATE 
SELECT SUM(end_ride)*100.0 / SUM(searches) FROM trips_details4;

--WHICH LOCATION GOT THE NUMBER OF TRIPS IN EACH DURATION PRESENT
SELECT * FROM
...
--WHICH DURATION GOT THE HIGHEST NUMBER OF THE TRIPS IN EACH OF THE LOCATION PRESENT
SELECT * FROM
...
--WHICH AREA GOT THE HIGHEST FARE, CANCELLATIONS, TRIPS
SELECT * FROM trips;
SELECT * FROM trips_details4;
...
-- DRIVER CANCELLATION - WHICH AREA HIGHER
